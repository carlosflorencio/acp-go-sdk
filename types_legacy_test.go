...
func TestLegacyModelsDecodeFromSessionResponses(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			models: func() *LegacyModels { return newSessionResponse.LegacyModels },
		},
		{
			name:   "load session",
			target: &loadSessionResponse,
			models: func() *LegacyModels { return loadSessionResponse.LegacyModels },
		},
		{
			name:   "fork session",
			target: &forkSessionResponse,
			models: func() *LegacyModels { return forkSessionResponse.LegacyModels },
		},
	}
